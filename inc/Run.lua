...
SUDO_USER = redis:hgetall(venom..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(venom..':WELCOME_BOT'),[[• مرحباً انا بوت ]]..redis:get(venom..':NameBot:')..[[ .
• اختـصاصـي حمايـة الـمجموعات
• تأكد من رفعـك للبـوت مشـرف في مجموعـتك واكتب تفعـيل 
• قنـاة سورس كيلر ⇐ @SOURCEVENOM
...
function tdcli_update_callback(data)
	...
	EditMsg(data.message_.chat_id_,data.message_.id_,'V')
	EditMsg(data.message_.chat_id_,data.message_.id_,'V  E')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/VENOM/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'VEN')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/VENOM/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'V  E  N  O')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/VENOM/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'VENO')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/VENOM/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/VENOM/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/VENOM/main/plugins/games.lua','./plugins/games.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'V  E  N  O  M\n\n• ** السورس الى اصدار \n• ** تم اعاده تشغيل سورس فينوم بنجاح')
	dofile("./inc/Run.lua")
